...
public final class StdOut {
   ...
   /**
    ...
    public static void printf(HashMap<String, String> maps) {
    	HashMap<String, String> Map = maps;
    	for (Map.Entry<String, String> entry : Map.entrySet()) {
//    		   System.out.println("key= " + entry.getKey() + " and value= " + entry.getValue());
    		   out.println("file name: " + entry.getKey() + " \t content: " + entry.getValue());
    		 }
    	
        out.flush();
    }
    
    public static void print(HashMap<String, String[]> maps) {
    	HashMap<String, String[]> Map = maps;
    	for (Map.Entry<String, String[]> entry : Map.entrySet()) {
//    		   System.out.println("key= " + entry.getKey() + " and value= " + entry.getValue());
    		String value = "";
    			...
    			for(int x= 0;x<entry.getValue().length;x++){
    				value = value+entry.getValue()[x]+" ";
    			}
    			out.println("file name: " + entry.getKey() + " \t file content" + value+"\n");
    		 }
//    	System.out.println();
        out.flush();
    }
    ...
    public static void print(String[] s) {
    			for(int x= 0;x<s.length;x++){
    				out.println("index: " + x + " \t content: " + s[x]+"\n");
    			}
//    	System.out.println();
        out.flush();
    }
    ...
    public static void print(String[][] s) {
    	if(s[0]!=null){
    		...
    		System.out.println("collection exception! collection cannot be empty");
    	}
